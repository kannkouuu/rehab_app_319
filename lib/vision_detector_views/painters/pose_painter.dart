      ...
      pose.landmarks.forEach((_, landmark) {
        canvas.drawCircle(
            Offset(
              ...
              translateY(landmark.y, rotation, size, absoluteImageSize),), 1, paint);
      });
      void paintLine(
        ...
        canvas.drawLine(
            ...
            Offset(translateX(joint2.x, rotation, size, absoluteImageSize),
                translateY(joint2.y, rotation, size, absoluteImageSize)), paintType);
      }
      ...
      if(Platform.isIOS){
        if(!forntcamra)
          posedata=[
            ...
            pose.landmarks[PoseLandmarkType.leftShoulder]?.z,//66
            pose.landmarks[PoseLandmarkType.rightShoulder]?.z,//67
            pose.landmarks[PoseLandmarkType.leftElbow]?.z,//68
            pose.landmarks[PoseLandmarkType.rightElbow]?.z,//69
            pose.landmarks[PoseLandmarkType.leftWrist]?.z,//70
            pose.landmarks[PoseLandmarkType.rightWrist]?.z,//71
            pose.landmarks[PoseLandmarkType.leftPinky]?.z,//72
            pose.landmarks[PoseLandmarkType.rightPinky]?.z,//73
            pose.landmarks[PoseLandmarkType.leftIndex]?.z,//74
            pose.landmarks[PoseLandmarkType.rightIndex]?.z,//75
            pose.landmarks[PoseLandmarkType.leftThumb]?.z,//76
            pose.landmarks[PoseLandmarkType.rightThumb]?.z,//77
          ...
          posedata=[
            ...
            pose.landmarks[PoseLandmarkType.leftShoulder]?.z,//22,23
            pose.landmarks[PoseLandmarkType.rightShoulder]?.z,//24,25
            pose.landmarks[PoseLandmarkType.leftElbow]?.z,//26,27
            pose.landmarks[PoseLandmarkType.rightElbow]?.z,//28,29
            pose.landmarks[PoseLandmarkType.leftWrist]?.z,//30,31
            pose.landmarks[PoseLandmarkType.rightWrist]?.z,//32,33
            pose.landmarks[PoseLandmarkType.leftPinky]?.z,//34,35
            pose.landmarks[PoseLandmarkType.rightPinky]?.z,//36,37
            pose.landmarks[PoseLandmarkType.leftIndex]?.z,//38,39
            pose.landmarks[PoseLandmarkType.rightIndex]?.z,//40,41
            pose.landmarks[PoseLandmarkType.leftThumb]?.z,//42,43
