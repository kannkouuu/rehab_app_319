...
class Detector_lift_feet_right implements Detector_default{
  ...
  void poseDetector() {
    ...
    if (this.startdDetector) {
      ...
      if (distance(posedata[54]!, posedata[55]!, posedata[56]!, posedata[57]!)>250 //腳踝距離
      ...
      //預防空值被訪問
      if (
      distance(posedata[54]!, posedata[55]!, posedata[56]!, posedata[57]!)<150 //腳踝距離
      ) {
        //確認復歸
        this.startdDetector = true;
        posesounder(false);
  ...
  Future<void> posesounder(bool BOO) async {
    ...
    if(BOO){
      ...
      await _audioPlayer.play(AssetSource('$baseAudioPath/lower/lift_feet_right.${getAudioDataForm()}'));
    }
  }
}
