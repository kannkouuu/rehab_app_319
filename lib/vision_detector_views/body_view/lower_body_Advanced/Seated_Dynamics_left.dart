...
class Detector_Seated_Dynamics_left implements Detector_default{
  ...
  Future<void> posesounder(bool BOO) async {
    ...
    if(BOO){
      ...
      await _audioPlayer.play(AssetSource('$baseAudioPath/lower/Seated_Dynamics_left.${getAudioDataForm()}'));
    }
  }
}
