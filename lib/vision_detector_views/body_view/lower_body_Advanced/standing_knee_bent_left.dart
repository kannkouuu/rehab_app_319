...
class Detector_standing_knee_bent_left implements Detector_default{
  ...
  void poseDetector() {
    ...
    if (this.startdDetector) {
      ...
      //預防空值被訪問
      if (
      angle(posedata[46]!, posedata[47]!, posedata[50]!, posedata[51]!, posedata[54]!, posedata[55]!)>130 //膝蓋角度
      ) {
        //確認復歸
        this.startdDetector = true;
        posesounder(false);
  ...
  Future<void> posesounder(bool BOO) async {
    ...
    if(BOO){
      ...
      await _audioPlayer.play(AssetSource('$baseAudioPath/lower/standing_knee_bent_left.${getAudioDataForm()}'));
    }
  }
}
