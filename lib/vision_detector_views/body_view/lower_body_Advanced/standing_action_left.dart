...
class Detector_standing_action_left implements Detector_default{
  ...
  Future<void> posesounder(bool BOO) async {
    ...
    if(BOO){
      ...
      await _audioPlayer.play(AssetSource('$baseAudioPath/lower/standing_action_left.${getAudioDataForm()}'));
    }
  }
}
