...
class Detector_towel_left implements Detector_default{
  ...
  Future<void> posesounder(bool BOO) async {
    ...
    if(BOO){
      await _audioPlayer.play(AssetSource('$baseAudioPath/upper/towel_right.${getAudioDataForm()}'));
    }else{
      await _audioPlayer.play(AssetSource('$baseAudioPath/upper/towel_left.${getAudioDataForm()}'));
    }
  }
}
