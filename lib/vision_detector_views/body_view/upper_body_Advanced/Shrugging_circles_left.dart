...
class Detector_Shrugging_circles_left implements Detector_default{
  ...
  Future<void> posesounder(bool BOO) async {
    ...
    if(BOO){
      ...
      await _audioPlayer.play(AssetSource('$baseAudioPath/upper/Shrugging_circles_left.${getAudioDataForm()}'));
    }
  }
}
