...
class Detector_elbow_movement_left implements Detector_default{
  ...
  Future<void> posesounder(bool BOO) async {
    ...
    if(BOO){
      ...
      await _audioPlayer.play(AssetSource('$baseAudioPath/upper/elbow_movement_left.${getAudioDataForm()}'));
    }
  }
}
