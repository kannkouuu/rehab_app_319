...
class Detector_wipe_table_right implements Detector_default{
  ...
  Future<void> posesounder(bool BOO) async {
    ...
    if(BOO){
      await _audioPlayer.play(AssetSource('$baseAudioPath/upper/wipe_table_left.${getAudioDataForm()}'));
    }else{
      await _audioPlayer.play(AssetSource('$baseAudioPath/upper/wipe_table_right.${getAudioDataForm()}'));
    }
  }
}
