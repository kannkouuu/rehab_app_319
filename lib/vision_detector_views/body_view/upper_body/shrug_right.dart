...
class Detector_shrug_right implements Detector_default{
  ...
  void setStandpoint() {
    ...
    this.Standpoint_Y = posedata[25]! - 10;
  ...
  Future<void> posesounder(bool BOO) async {
    ...
    if(BOO){
      ...
      await _audioPlayer.play(AssetSource('$baseAudioPath/upper/shrug_right.${getAudioDataForm()}'));
    }
  }
}
