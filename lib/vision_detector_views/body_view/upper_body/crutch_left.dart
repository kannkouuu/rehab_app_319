...
class Detector_crutch_left implements Detector_default{
  ...
  bool timerui = true;
  String mindText = "請將全身拍攝於畫面內並微面右邊\n並維持手機直立\n準備完成請按「Start」";
  ...
  Future<void> posesounder(bool BOO) async {
    ...
    if(BOO){
      ...
      await _audioPlayer.play(AssetSource('$baseAudioPath/upper/crutch_left.${getAudioDataForm()}'));
    }
  }
}
