...
class Detector_bath_left implements Detector_default{
  ...
  Future<void> posesounder(bool BOO) async {
    ...
    if(BOO){
      await _audioPlayer.play(AssetSource('$baseAudioPath/upper/bath_left.${getAudioDataForm()}'));
    }else{
      await _audioPlayer.play(AssetSource('$baseAudioPath/lower/upper/bath_right.${getAudioDataForm()}'));
    }
  }
}
