...
class Detector_calf_knees_right implements Detector_default{
  ...
  void poseDetector() {
    ...
    if (this.startdDetector) {
      ...
      //預防空值被訪問
      if (
      angle(posedata[48]!, posedata[49]!, posedata[52]!, posedata[53]!, posedata[56]!, posedata[57]!)<120 //膝蓋角度
      ) {
        //確認復歸
        this.startdDetector = true;
        posesounder(false);
  ...
  Future<void> posesounder(bool BOO) async {
    ...
    if(BOO){
      ...
      await _audioPlayer.play(AssetSource('$baseAudioPath/lower/calf_knees_right.${getAudioDataForm()}'));
    }
  }
}
