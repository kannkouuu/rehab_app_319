...
class Detector_raise_feet_left implements Detector_default{
  ...
  Future<void> posesounder(bool BOO) async {
    ...
    if(BOO){
      ...
      await _audioPlayer.play(AssetSource('$baseAudioPath/lower/raise_feet_left.${getAudioDataForm()}'));
    }
  }
}
