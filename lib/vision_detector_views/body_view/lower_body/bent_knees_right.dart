...
class Detector_bent_knees_right implements Detector_default{
  ...
  void poseDetector() {
    ...
    if (this.startdDetector) {
      DetectorED = true;
      this.orderText = "請往後彎曲右腳";
      if (angle(posedata[48]!, posedata[49]!, posedata[52]!, posedata[53]!, posedata[56]!, posedata[57]!)<130 //膝蓋角度
      ) {
  ...
  Future<void> posesounder(bool BOO) async {
    ...
    if(BOO){
      ...
      await _audioPlayer.play(AssetSource('$baseAudioPath/lower/bent_knees_right.${getAudioDataForm()}'));
    }
  }
}
