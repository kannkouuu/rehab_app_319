  ...
  void poseDetector() {
    ...
    if (this.startdDetector) {
      ...
      if (right_side) {
        ...
        if (distance(posedata[16]!, posedata[17]!, posedata[24]!,
                    posedata[25]!) <
                310 //耳與肩膀距離
            &&
            this.startdDetector) {
        ...
        if (distance(posedata[14]!, posedata[15]!, posedata[22]!,
                    posedata[23]!) <
                310 //耳與肩膀距離
            &&
            this.startdDetector) {
      ...
      //預防空值被訪問
      if (distance(posedata[16]!, posedata[17]!, posedata[24]!, posedata[25]!) >
                  210 //耳與肩膀距離
              ||
              distance(posedata[14]!, posedata[15]!, posedata[22]!,
                      posedata[23]!) >
                  210 //耳與肩膀距離
          ) {
        //確認復歸
